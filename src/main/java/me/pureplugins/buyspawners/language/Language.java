...
public enum Language {
    ...
    SUCCESS_CHAGNE("sucsess-change", "&7You set that spawner to a &c%type% &7spawner."),
    SUCCESS_MINE("sucsess-mine", "&7You mined a &c%type% &7spawner."),
    SUCCESS_PLACE("sucsess-place", "&7You placed a &c%type% &7spawner."),
